...
def generate_data():#external functions for plotting
    '''
    generate data
...
#external functions for plotting
...
class NeuralNetwork(object):
    ...
    def actFun(self, z, type):#activatity function
        '''
    ...
    def diff_actFun(self, z, type):# activaty function's difference
        '''
    ...
    def calculate_loss(self, X, y):#calculate error
        '''
    ...
    def predict(self, X):#run feedforward
        '''
    ...
    def backprop(self, X, y):
        ...
        delta2 = delta3.dot(self.W2.T) * self.diff_actFun(self.z1, self.actFun_type)        # dW1 = dL/dW1
        dW1 = np.dot(X.T, delta2)      # db1 = dL/db1
        db1 = np.sum(delta2, axis=0)

        return dW1, dW2, db1, db2

    def fit_model(self, X, y, epsilon=0.01, num_passes=20000, print_loss=True):#training
        '''
