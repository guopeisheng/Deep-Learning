...
def generate_circle_data():
    ...
    '''
    np.random.seed(0)
    X, y = datasets.make_circles(200, noise=0.02)
    return X, y
...
class NeuralNetwork(object):
    """
    This class builds and trains a n-layer neural network
    """
...
def main():
    ...
    model = NeuralNetwork(nn_input_dim=2, nn_hidden_dim = 4, nn_output_dim=2, num_layers = 6, actFun_type='sigmoid')
    # model.fit_model(X,y)
